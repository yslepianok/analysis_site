...
<div  ng-app="platonic_solidsApp">
	<div ng-controller="platonic_solidsController">
		<div class="allcenter">
			<h1 class="z1">Тестирование по предпочтениям платоновых тел</h1>
		</div>
    ...
    <!-- Начало логики цикла с вопросами-->
      ...
      <img ng-if="question.url" src="{{question.url}}" alt="question.text">
			<br>
			<div class="allcenter test_el thumbnail" ng-repeat="answer in question.answers" class="col-xs-6 col-md-3" ng-click="itemSelected(answer)">
        {{answer.text}}
