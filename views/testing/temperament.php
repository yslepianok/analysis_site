...
<script type="text/javascript" src="../js/temperamentController.js"></script>
<div  ng-app="temperamentApp">
	<div ng-controller="temperamentController">
		<div class="allcenter">
			<h1 class="z1">Прогноз темперамента на основании психологического теста</h1>
		</div>
