...
<script type="text/javascript" src="../js/activity_levelsController.js"></script>
<div  ng-app="activity_levelsApp">
	<div ng-controller="activity_levelsController">
		<div class="allcenter">
			<h1 class="z1">Тестирование по уровням деятельности</h1>
		</div>
    ...
    <!-- Конец логики цикла с вопросами-->
		...
		<div class="allcenter" ng-if="currentTest >= testData.questions.length">
				...
				<button class="btn btn-default" ng-click="saveResults()"> Назад к списку тестов</button>
		</div>
	</div>
</div>
