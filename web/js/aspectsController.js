var myApp = angular.module('aspectsApp', []);

myApp.controller('aspectsController', ['$scope', '$http', function($scope, $http) {
    $http.get("../testing/test?name=aspects").then(function (response) {
  ...
  $scope.url = 'testingresults';
    ...
    console.log("in start aspects testing")
			$scope.flag = 1;
			$scope.flag2 = 1;
			$scope.currentTest = 0;
	}
