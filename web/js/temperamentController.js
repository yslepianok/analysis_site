var myApp = angular.module('temperamentApp', []);

myApp.controller('temperamentController', ['$scope', '$http', function($scope, $http) {
    $http.get("../testing/test?name=temperament").then(function (response) {
  ...
  $scope.url = 'testingresults';
	...
	$scope.Start = function(){
		console.log("in start temperament testing")
		$scope.flag = 1;
		$scope.flag2 = 1;
		$scope.currentTest = 0;
	}
