var myApp = angular.module('tasteApp', []);

myApp.controller('tasteController', ['$scope', '$http', function($scope, $http) {
    $http.get("../testing/test?name=taste").then(function (response) {
  ...
  $scope.url = 'testingresults';
    ...
    console.log("in start taste testing")
			$scope.flag = 1;
			$scope.flag2 = 1;
			$scope.currentTest = 0;
	}
